...
<nav class="navbar navbar-inverse carvan-header-prod">
    <div class="navbar-header">
      ...
      <a class="navbar-brand img_menu" href="index.php"><img src="img/carvan.png" width="70px" alt=""></a>
    </div>
...
<footer class="footer-distributed">
    <div class="footer-left"> <img src="img/carvan.png" alt="">
        <p class="footer-links"> <a href="index.php">Home</a> · <a href="about.php">About</a> · <a href="#">Brands</a> · <a href="#">Range</a> · <a href="contact.php ">Contact</a> </p>
